 ...
 * @Comments:null
 */
public class GalleryGridFragment extends Fragment implements OnActionModeListener, EyePosition.EyePositionListener, SelectionListener {
    ...
    private void initializeViews() {
        ...
        ViewConfigs.AlbumSetGridPage config = ViewConfigs.AlbumSetGridPage.get(mLetoolContext.getActivityContext());
        layout = new ThumbnailSetContractLayout(config.albumSetGridSpec, false);
        ...
        mThumbnailView.setListener(new ThumbnailView.SimpleListener() {
            ...
            public void onDown(int index) {
                GalleryGridFragment.this.onDown(index);
            }

            @Override
            public void onUp(boolean followedByLongPress) {
                GalleryGridFragment.this.onUp(followedByLongPress);
            }

            @Override
            public void onSingleTapUp(int thumbnailIndex) {
                GalleryGridFragment.this.onSingleTapUp(thumbnailIndex);
            }

            @Override
            public void onLongTap(int thumbnailIndex) {
                GalleryGridFragment.this.onLongTap(thumbnailIndex);
            }
        });
    }
